...
Ext.define('etecsa.controller.nomenclador.access_level', {
    ...
    control: {
        ...
        'access_level-grid [text=Adicionar]': {
            click: "show_form"
        },
        'access_level-win': {
            afterrender: "after_render_window"
        },
        'access_level-win [text=Salvar]': {
            click: "is_valid"
        },
        'access_level-grid [text=Eliminar]': {
    ...
    show_form: function () { var me = this;
        Ext.create('etecsa.view.nivel_acceso.form', {
            store: me.store
        });
    },
    is_valid: function () {
    ...
    edit: function (editor, context){ var me = this;
        Ext.Ajax.request({
            url: '/nomenclador/access_level/edit',
            params: {
                id: context.record.get('id'),
                nivel: context.record.get('nivel'),
    ...
    remove: function () { var me = this, ids = [];
        ...
        Ext.Ajax.request({
            url: '/nomenclador/access_level/remove',
